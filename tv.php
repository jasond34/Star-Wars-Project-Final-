		  ...
		  <div class="container-fluid text-center">
			...
			<div>
			  <ul class="nav navbar-nav">
				...
				<li class="active"><a href="tv.php"><b>TV Shows</b></a></li>
			...
			<div class="Title">Star Wars TV SHOW!</div>
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					 <div class="span12" style="border: 2px solid white">
								
								<img src="http://static.comicvine.com/uploads/scale_super/13/132327/3707586-clone_wars_5_poster_by_denisogloblin-d641dlg.jpg" height="400" width="320">
								
								<br><br><br><h1>THE CLONE WARS</h1>
						      <h2>Description</h2>

									<div class="section">Star Wars: The Clone Wars is an animated television series set between the events of Star Wars: Episode II Attack of the Clones and Star Wars: Episode III 
									Revenge of the Sith, and during the same time period as the earlier series Star Wars: Clone Wars. Star Wars: The Clone Wars follows the Republic’s clone army in their struggle 
									against Count Dooku’s Separatist forces, and features fan-favorite characters like Anakin Skywalker, Obi-Wan Kenobi, Ahsoka Tano, and Darth Maul. </div>
					
					</div>
				</div>
				<div class="col-md-6">
					<div class="span12" style="border: 2px solid white">
						<img src="http://ia.media-imdb.com/images/M/MV5BMjMyNTc4NDI5OV5BMl5BanBnXkFtZTgwMzI4OTg5MjE@._V1_SX640_SY720_.jpg" height="440" width="340">
								
								<h1>REBELS</h1>
						      <h2>Description</h2>

									<div class="section">Star Wars Rebels is an animated television series set five years before the events of the Star Wars original trilogy, during the time frame between the films 
									Star Wars: Episode III Revenge of the Sith and Star Wars: Episode IV A New Hope. The series follows a motley group of rebels who live aboard the starship Ghost as they fight 
									against the evil Galactic Empire. The rebels include Ezra Bridger, a young orphan from Lothal who learns he can use the Force; Kanan Jarrus, a Jedi who survived Order 66; 
									Hera Syndulla, a Twi'lek pilot and veteran resistance fighter; Sabine Wren, a Mandalorian explosives expert; Garazeb "Zeb" Orrelios, a Lasat warrior; and the cantankerous 
									astromech droid C1-10P, also known as Chopper. The crew will eventually help give rise to the Rebel Alliance. </div>
					</div>
				</div>
			</div>
