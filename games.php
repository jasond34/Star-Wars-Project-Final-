...
var eventdate = new Date("November 17, 2015 0:0:00");
	function toSt(n) {
	s=""
	if(n<10) s+="0"
	return s+n.toString();
		  ...
		  <div class="container-fluid text-center">
			...
			<div>
			  <ul class="nav navbar-nav">
				...
				<li class="active"><a href="games.php"><b>Games</b></a></li>
			...
			<div class="Title">Star Wars Battlefront</div>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					 <div class="span12" style="border: 2px solid white">
								
								<img src="http://i0.wp.com/www.heyuguys.com/images/2015/04/Battlefront.jpg?resize=4785%2C2553" height="700" width="1107">
								<br>
								<br>
								<h1>Coming Soon!<br></h1>
									<div class="container" id="counter">
												<FORM name="clock">
													<TABLE BORDER=5 CELLSPACING=5 CELLPADDING=0 BGCOLOR="#FF0000">
													<TR>
													<TD ALIGN=CENTER WIDTH="31%" BGCOLOR="#003300"><FONT COLOR="#FF0000"><B>Days:</B></FONT></TD>
													<TD ALIGN=CENTER WIDTH="23%" BGCOLOR="#003300"><FONT COLOR="#FF0000"><B>Hours:</B></FONT></TD>
													<TD ALIGN=CENTER WIDTH="23%" BGCOLOR="#003300"><FONT COLOR="#FF0000"><B>Mins:</B></FONT></TD>
													<TD ALIGN=CENTER WIDTH="23%" BGCOLOR="#003300"><FONT COLOR="#FF0000"><B>Secs:</B></FONT></TD>
													</TR>
													<TR>
													...
													<CENTER><P><FONT FACE="arial,helvetica" SIZE="+2" COLOR="#FFFF00">Until Battlefronts</FONT></CENTER>
													</TD>
													</TR>
									...
									<div class="container">
										<div class="row">
											<div class="col-md-11">
												...
												<div id="description">
													Star Wars Battlefront is an upcoming action video game 
													based on the Star Wars franchise. The third major 
													release in the Star Wars: Battlefront series, it is 
													being developed by EA DICE and will be published by 
													Electronic Arts. It is a reboot to the Battlefront 
													series, thus making this the first game of the new 
													'Canon' (everything that affects the major storyline),
													while other games are now part of the 'Legends'(the Expanded Universe).
										...
										<p></p>	Check this amazing gameplay footage out! </p>
												<iframe width="625" height="400" src="https://www.youtube.com/embed/jXU5k4U8x20" frameborder="0" allowfullscreen></iframe>
											</div>
										</div>
									</div>
								</div>
